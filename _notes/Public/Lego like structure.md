...
### Atomic Concept
1. Lego Blocks are the smallest component. You can't break it into smaller component. 
...
5. Lego sells it in 'thematic form'. One contains flight, other contains crane. - You can define a theme by choosing not to include out of scope elements. 
